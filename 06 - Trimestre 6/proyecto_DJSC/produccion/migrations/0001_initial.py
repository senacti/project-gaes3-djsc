    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.activity')),
                ('novelty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.novelty_production')),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.state_production')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.type_production')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='activity',
            name='novelty',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.novelty_activity'),
        ),
        migrations.AddField(
            model_name='activity',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.state_activity'),
        ),
        migrations.AddField(
            model_name='activity',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produccion.type_activity'),
        ),
    ]
