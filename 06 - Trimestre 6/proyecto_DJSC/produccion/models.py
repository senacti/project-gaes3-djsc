...
class Production(models.Model):
    ...
    novelty = models.ForeignKey(Novelty_Production, on_delete=models.CASCADE)
    type = models.ForeignKey(Type_Production, on_delete=models.CASCADE)
    state = models.ForeignKey(State_Production, on_delete=models.CASCADE)
