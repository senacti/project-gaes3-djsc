...
<body>
    ...
    <section class="form-register">
        ...
        <p class=" me-5" style="background: none;"><input type="checkbox" name="RECORDARME"> Aceptar Terminos y Condiciones</p>
        <input class="botons" type="submit" value="registrarse">
        <p style="background: none;"><a style="background: none;" href="{{url('/iniciosesion')}}">¿Ya posee una Cuenta?</a></p>
      </section>
    </form>
