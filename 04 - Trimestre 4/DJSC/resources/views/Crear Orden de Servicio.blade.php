...
<body>
    <section class="form-register">
        ...
        <input class="controlsj4" type="number" placeholder="Ingrese Cantidad" required id="CantidaddeProductos">
        <span style="background: none;" class="col-1" id="CantidaddeProductosOK"></span>
        <input class="controlsj5" type="text" placeholder="Ingrese detalles" required id="detallesdelServicio">
