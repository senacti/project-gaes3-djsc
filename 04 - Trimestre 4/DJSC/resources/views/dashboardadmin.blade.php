      ...
      <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
          ...
          <ul class="list-unstyled px-2">
            ...
            <li class=""><a class="text-decoration-none px-3 py-2 d-block" href="{{url('/consultarordenesservicio')}}"target="pedidos"><i class="fas fa-search"></i></i>consultar ordenes de servicio</a></li>
